...
void func_2243()
{
    ...
    sv_set_mem(0x1, 0, 0x152, func_2263);
    sv_set_mem(0x1, 0x1, 0x152, func_2264);
    sv_set_mem(0x1, 0x2, 0x152, func_2267);
    sv_set_mem(0x1, 0, 0x153, func_2284);
    sv_set_mem(0x1, 0x1, 0x153, func_2285);
    sv_set_mem(0x1, 0x2, 0x153, func_2287);
    sv_set_mem(0x1, 0, 0x154, func_2247);
    sv_set_mem(0x1, 0x1, 0x154, func_2248);
    sv_set_mem(0x1, 0x2, 0x154, func_2250);
    sv_set_mem(0x1, 0, 0x155, func_2252);
    sv_set_mem(0x1, 0x1, 0x155, func_2253);
    sv_set_mem(0x1, 0x2, 0x155, func_2256);
    sv_set_mem(0x1, 0, 0x156, func_2305);
    sv_set_mem(0x1, 0x1, 0x156, func_2306);
    sv_set_mem(0x1, 0x2, 0x156, func_2309);
    sv_set_mem(0x1, 0, 0x157, func_2278);
    sv_set_mem(0x1, 0x1, 0x157, func_2279);
    sv_set_mem(0x1, 0x2, 0x157, func_2283);
    sv_set_mem(0x1, 0, 0x158, func_2268);
    sv_set_mem(0x1, 0x1, 0x158, func_2269);
    sv_set_mem(0x1, 0x2, 0x158, func_2272);
    sv_set_mem(0x1, 0, 0x159, func_2273);
    sv_set_mem(0x1, 0x1, 0x159, func_2274);
    sv_set_mem(0x1, 0x2, 0x159, func_2277);
    sv_set_mem(0x1, 0, 0x15a, func_2293);
    sv_set_mem(0x1, 0x1, 0x15a, func_2294);
    sv_set_mem(0x1, 0x2, 0x15a, func_2296);
    sv_set_mem(0x1, 0, 0x15b, func_2297);
    sv_set_mem(0x1, 0x1, 0x15b, func_2298);
    sv_set_mem(0x1, 0x2, 0x15b, func_2300);
    sv_set_mem(0x1, 0, 0x15c, func_2301);
    sv_set_mem(0x1, 0x1, 0x15c, func_2302);
    sv_set_mem(0x1, 0x2, 0x15c, func_2304);
    sv_set_mem(0x1, 0, 0x15d, func_2258);
    sv_set_mem(0x1, 0x1, 0x15d, func_2259);
    sv_set_mem(0x1, 0x2, 0x15d, func_2262);
    sv_set_mem(0x1, 0, 0x15e, func_2310);
    sv_set_mem(0x1, 0x1, 0x15e, func_2311);
    sv_set_mem(0x1, 0x2, 0x15e, func_2314);
    sv_set_mem(0x1, 0, 0x15f, func_2315);
    sv_set_mem(0x1, 0x1, 0x15f, func_2316);
    sv_set_mem(0x1, 0x2, 0x15f, func_2319);
    sv_set_mem(0x1, 0, 0x160, func_2320);
    sv_set_mem(0x1, 0x1, 0x160, func_2321);
    sv_set_mem(0x1, 0x2, 0x160, func_2324);
    sv_set_mem(0x1, 0x2, 0x14d, func_2257);
}
...
void func_2302()
{
    ...
    {
        WorkModuleImpl.set_int(0x255, 0x11000002);
        WorkModuleImpl.set_int(0x279, 0x11000003);
    }
    else
    {
...
void func_2306()
{
    ...
    WorkModuleImpl.off_flag2(0x2100000d);
    WorkModuleImpl.set_int(0x295, 0x11000002);
    WorkModuleImpl.set_int(0x299, 0x11000003);
    func_2308();
    func_78(func_2307);
}
...
void func_2311()
{
    ...
    global16 = func_2312;
    WorkModuleImpl.set_int(0x296, 0x11000002);
...
void func_2316()
{
    WorkModuleImpl.off_flag2(0x2100000d);
    JostleModuleImpl(0x2710, 0);
    WorkModuleImpl.set_int(0x297, 0x11000002);
    WorkModuleImpl.set_int(0x29a, 0x11000003);
    func_2318();
    func_78(func_2317);
}
...
void func_2321()
{
    WorkModuleImpl.off_flag2(0x2100000d);
    JostleModuleImpl(0x2710, 0);
    WorkModuleImpl.set_int(0x298, 0x11000002);
    WorkModuleImpl.set_int(0x29b, 0x11000003);
    sys_21(0x8c);
    func_2323();
    func_78(func_2322);
}
